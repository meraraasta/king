    ...
    <>
      ...
      <Col lg={2} md={2} sm={2} xs={12}>
        <Form.Group className="mb-3" controlId="time">
          <Form.Label className="CustomLabel">ID</Form.Label>
          <Form.Select
            aria-label="Default select example"
            onChange={(e) => setID(e.target.value)}
            // onChange={(e) => changeGame}
            value={id}
          >
      ...
      <Col lg={12} md={12} sm={12} xs={12}>
        <Button onClick={handlerGetGame} className="primary">
          Get
        </Button>
        <Button onClick={handlerAddGame} className="primary">
          Add
        </Button>
        <Button onClick={handlerUpdateGame} className="primary">
          Update
        </Button>
        <Button onClick={handlerDeleteGame} className="primary">
          Delete
        </Button>
      </Col>
